...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/ClanX/main/izin | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/ClanX/main/izin | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
Name=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/ClanX/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/ClanX/main/izin | grep $MYIP | awk '{print $3}')
...
echo -e "${GREEN}| \E[44;1;39m         °SCRIPT PREMIUM BY ClanXVPN°        \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
echo -e "• Today's Status     = $(cat /root/status)${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "$GREEN┌──────────────────────────────────────────────────┐${NC}"
...
echo -e " ${CYAN}[${BIWhite}04${BICyan}]${RED} •${NC} ${CYAN}TROJAN MENU     $NC  ${CYAN}[${BIWhite}09${BICyan}]${RED} • ${NC}${CYAN}SETTINGS $NC"
echo -e " ${CYAN}[${BIWhite}05${BICyan}]${RED} •${NC} ${CYAN}S-SOCK MENU     $NC  ${CYAN}[${BIWhite}10${BICyan}]${RED} • ${NC}${CYAN}CHECK UPDATE  $NC" 
